...
let bColors:[UIColor] = [
    UIColor(red:0.1, green:0.5, blue:0.4, alpha:1),
    ...
    UIColor(red:0.8, green:0.4, blue:0.1, alpha:1),
...
class SaveLoadViewController: UIViewController,UITableViewDataSource, UITableViewDelegate,SLCellDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if dateString == "**" {
            ...
            str = String(format:"%2d     Equ %d, %@", indexPath.row+1,cc.formula + 1,dateString)
